...
install_xcframework "${PODS_ROOT}/AppLovinSDK/applovin-ios-sdk-11.2.1/AppLovinSDK.xcframework" "AppLovinSDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
