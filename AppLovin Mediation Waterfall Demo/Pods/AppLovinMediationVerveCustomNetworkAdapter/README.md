...
* AppLovin Verve bidding adapter: [2.18.0.0](https://github.com/AppLovin/AppLovin-MAX-SDK-iOS/blob/master/Verve/CHANGELOG.md)
* Verve HyBid SDK: [2.18.0](https://github.com/pubnative/pubnative-hybid-ios-sdk/releases)
