...
* AppLovin Verve bidding adapter: [2.21.2.0](https://github.com/AppLovin/AppLovin-MAX-SDK-iOS/blob/master/Verve/CHANGELOG.md)
* Verve HyBid SDK: [2.21.2](https://github.com/pubnative/pubnative-hybid-ios-sdk/releases)
