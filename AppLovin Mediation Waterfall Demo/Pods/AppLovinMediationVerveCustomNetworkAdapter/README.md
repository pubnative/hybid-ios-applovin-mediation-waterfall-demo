...
* AppLovin Verve bidding adapter: [2.21.1.0](https://github.com/AppLovin/AppLovin-MAX-SDK-iOS/blob/master/Verve/CHANGELOG.md)
* Verve HyBid SDK: [2.21.1](https://github.com/pubnative/pubnative-hybid-ios-sdk/releases)
