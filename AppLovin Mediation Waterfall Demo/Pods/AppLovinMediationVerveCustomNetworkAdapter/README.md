...
* AppLovin Verve bidding adapter: [3.0.3.0](https://github.com/AppLovin/AppLovin-MAX-SDK-iOS/blob/master/Verve/CHANGELOG.md)
* Verve HyBid SDK: [3.0.3](https://github.com/pubnative/pubnative-hybid-ios-sdk/releases)
